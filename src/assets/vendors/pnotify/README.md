...
* `pnotify.custom.js` & `pnotify.o_name.js` (Minified)
* `pnotify.custom.css` & `pnotify.o_name.css` (Minified)

So here's how you'd include them on your page:

```html
<script type="text/javascript" src="pnotify.o_name.js"></script>
<link href="pnotify.o_name.css" media="all" rel="stylesheet" type="text/css" />
```
